            ...
            <td class="text-muted">
              <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown sale-action-menu"
                     ...
                     data-preview-url="{{ route('invoice.modal-preview', ['sale_id' => $sale->id]) }}"
                     data-pdf-url="{{ route('invoice.download-pdf', ['sale_id' => $sale->id]) }}"
                     data-print-url="{{ route('invoice.modal-preview', ['sale_id' => $sale->id, 'print' => 1]) }}"
                     data-delivery-preview-url="{{ route('invoice.modal-preview', ['sale_id' => $sale->id, 'doc' => 'delivery_challan']) }}"
