...
<input type="hidden" class="party-id" name="party_id">
                            ...
                            <div class="header-right w-25">
                                ...
                                <div class="input-group invoice-number-group">
                                    ...
                                    <input type="text" class="input-control underline-input bill-number" value="{{ $nextInvoiceNumber ?? '' }}" placeholder="Reference No.">
                                </div>
                                <div class="input-group date-wrapper invoice-date-group">
                                    <span>Invoice Date</span>
                                    <input type="date" class="input-control underline-input invoice-date" value="{{ now()->format('Y-m-d') }}">
                                </div>
...
<script>
    ...
    window.saleReturnStoreUrl = "{{ route('proforma-invoice.store') }}";
 ...
 window.docType = "proforma";
    ...
    @if(isset($saleReturn))
        // Edit mode
        window.saleReturnStoreUrl = "{{ route('proforma-invoice.update', $saleReturn->id) }}";
    ...
    @elseif(isset($convertedSaleData))
        // Convert from estimate / sale order / challan / proforma invoice
