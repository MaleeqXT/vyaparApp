(function () {
  ...
  const modalEl = document.getElementById('globalTransactionPasscodeModal');
  const inputEl = document.getElementById('globalTransactionPasscodeInput');
  const errorEl = document.getElementById('globalTransactionPasscodeError');
  const confirmBtn = document.getElementById('globalTransactionPasscodeConfirm');
